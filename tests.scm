...
(let ((a (define x 2)) (a (define x 3))) a)
; expect Error
...
(define (sum_doubles x y) (+ (* x 2) (* y 2)))
sum_doubles
; expect (lambda (x y) (+ (* x 2) (* y 2)))
...
(define a (begin '(a b) (lambda (x) (+ 5 6) (* x 2))))
; expect a
